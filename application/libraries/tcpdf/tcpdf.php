...
//			$this->writeHTMLCell(0, 0, 0, 0, "PSM tech", 0, 0, false, true, 'C');
			$this->endTemplate();
		}
...
//			$this->Cell(0, 10, "371 South Swing Road, PI Greensboro, NC-27409", 0, false, 'L', 0, '', 0, false, 'T', 'M');
			$html = '371 South Swing Road, PI Greensboro, NC-27409<br/>
                 E-mail: info@psmtech.com<br/>
                 Phone: (336)-285-9178, (336)-285-9177';
//			$this->writeHTMLCell(0, 10, '', '', $html, 0, 0, false, true, 'L', true);
			$this->Cell(0, 10, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, 0, 'R', 0, '', 0, false, 'T', 'M');
