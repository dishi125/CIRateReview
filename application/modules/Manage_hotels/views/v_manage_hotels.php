				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between">
							<h4 class="mb-sm-0">Manage Hotels</h4>
						...
						<div class="card">
							<div class="card-header border-0">
								<div class="d-flex align-items-center">
									<h5 class="card-title mb-0 flex-grow-1">List of Hotels</h5>
									<div class="flex-shrink-0">
										<button type="button" class="btn btn-success add-btn" id="add_btn_manage_hotel"><i class="ri-add-line align-bottom me-1"></i> Add Hotel</button>
									</div>
								</div>
							</div>
							...
							<div class="card-body pt-0">
								<div class="live-preview">
									<div class="table-responsive table-card mb-1 mt-1">
										<table class="table table-nowrap align-middle" id="List_Manage_Hotel_table">
...
<div class="modal fade zoomIn" id="deleteManageHotelModal" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="d-flex gap-2 justify-content-center mt-4 mb-2">
					...
					<button type="button" class="btn w-sm btn-danger" id="delete_manage_hotel">Yes, Delete It!</button>
				</div>
			</div>
		</div>
	</div>
...
$(document).ready(function (){
	table = $("#List_Manage_Hotel_table").DataTable();
})

$(document).on("click", "#add_btn_manage_hotel", function (){
	location.href = "<?php echo base_url('add_hotels') ?>";
})

function delete_hotel(HotelId){
	$("#delete_manage_hotel").attr('hotel-id',HotelId);
	$("#deleteManageHotelModal").modal('show');
}

$(document).on('click', '#delete_manage_hotel', function() {
	var HotelId = $(this).attr('hotel-id');
	var userId = $("#users_dropdown").val();
	$(this).attr('disabled','disabled');
	var thi = $(this);
	$.ajax({
		url: "<?php echo base_url().'delete_client_hotel'; ?>",
		method: "POST",
		...
		success: function (res) {
			...
			if (res.status == true ){
				...
				table.destroy();
				$("#List_Manage_Hotel_table tbody").html(res.html);
				table = $("#List_Manage_Hotel_table").DataTable();
				$("#deleteManageHotelModal").modal('hide');
			}
...
function filterManageHotelDataBycustomer(){
	var userId = $("#users_dropdown").val();
	$.ajax({
		url: "<?php echo base_url().'get_client_hotellist/'; ?>" + userId,
		method: "POST",
		success: function (res) {
			var res = JSON.parse(res);
			if (res.status == 1){
