						...
						<div class="card">
							<div class="card-header border-0">
								<div class="d-flex align-items-center">
									<h5 class="card-title mb-0 flex-grow-1">Add <?= $type ?></h5>
								</div>
							</div>

							<div class="card-body pt-0">
								<form method="post" id="add_hotel">
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-xxl-3 col-md-4">
										<div>
											...
											<input type="text" name="mapped_hotel_name" id="mapped_hotel_name" class="form-control">
									...
									<div class="col-xxl-3 col-md-4">
										...
										<div>
											...
											<select name="hotel_code" id="hotel_code" class="form-control own_hotel_code_dropdown">
												...
												<option value="<?= $own_hotel['HotelCode'] ?>"><?= $own_hotel['MappedHotelName'] ?></option>
												<?php } ?>
											</select>
								...
								<div class="row" id="add_room_hotel_div">
									<div class="col-xxl-3 col-md-4">
										<div>
...
$(document).on("click", "#save_hotel", function (){
	...
	if(validate_add_hotel_form()){
		$.ajax({
			url: "<?php echo base_url().'save_hotel'; ?>",
			method: "POST",
			data: formData,
			dataType: "json",
			contentType: false,
...
function validate_add_hotel_form()
{
	...
	if($("#add_hotel").valid() && $("#mapped_rooms_div").html() != ""){
		return true;
	}
	else {
		return false;
