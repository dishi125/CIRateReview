...
<body>
<div class="container">
	<h3 style="text-align:left;float:left;">Hello, <?= $username ?></h3>
	<h3>Responded Review Report:<h3><h3 style="text-align:right;float:right;"><?= date("m-d-Y", strtotime($date)) ?></h3>
	<hr style="clear:both;"/>
	<div class="table-responsive">
		<table class="table table-bordered align-middle table-nowrap mt-2" border="1" width="100%">
			<thead>
			<tr>
			...
			<?php } ?>
                                            ...
                                            <p class="text-muted mb-1">Thanks.</p>
                                            <p class="text-muted mb-1">Best Regards </p>
											<p class="text-muted mb-1">Psmtech Team. </p>
