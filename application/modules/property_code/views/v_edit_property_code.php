						...
						<div class="card">
							<div class="card-header border-0">
								<div class="d-flex align-items-center">
									<h5 class="card-title mb-0 flex-grow-1">Edit Property</h5>
								</div>
							</div>

							<div class="card-body pt-0">
								<form method="post" id="edit_property">
									<input type="hidden" name="id" value="<?= $Property_code['id'] ?>">
									<div class="row">
										<div class="col-6">
											<div>
												<label for="labelInput" class="form-label">Property Name</label>
												<input type="text" name="PropertyName" id="PropertyName" class="form-control" value="<?= $Property_code['PropertyName'] ?>">
										...
										<div class="col-6">
											<div>
												...
												<input type="text" name="HotelCode" id="HotelCode" class="form-control" value="<?= $Property_code['HotelCode'] ?>">
...
<button type="button" id="success_toast" data-toast data-toast-text="Property Updated Successfully" data-toast-gravity="top" data-toast-position="right" data-toast-duration="3000" data-toast-close="close" class="btn btn-light w-xs" data-toast-classname="success"></button>
...
$(document).on("click", "#save_property", function (){
	...
	var formData = new FormData($('#edit_property')[0]);
